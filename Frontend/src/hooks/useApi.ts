  ...
  return useMutation({
    mutationFn: async ({ buyerId, type }: { buyerId: string; type: 'linkedin' | 'email' | 'whatsapp' }) => {
      try {
        ...
        // Fallback: ReachIQ smart mock — varied, non-templated messages
